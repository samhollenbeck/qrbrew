...
export function calculateCarbonation(bottle: Bottle, sugars: SugarAdditions): 'none' | 'low' | 'moderate' | 'heavy' {
...
export function calculateAcidity(bottle: Bottle): 'none' | 'light' | 'balanced' | 'bright' | 'bold' {
